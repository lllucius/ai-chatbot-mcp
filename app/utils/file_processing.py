...
class FileProcessor:
    ...
    async def _extract_pdf(self, file_path: str) -> str:
        ...
        try:
            ...
            try:
                ...
                raise DocumentError("PDF processing library not available. Install PyPDF2 or pypdf.")
        except Exception as e:
    ...
    async def _extract_docx(self, file_path: str) -> str:
        ...
        try:
            ...
            raise DocumentError("DOCX processing library not available. Install python-docx.")
        except Exception as e:
    ...
    async def _extract_rtf(self, file_path: str) -> str:
        ...
        try:
            ...
            raise DocumentError("RTF processing library not available. Install striprtf.")
        except Exception as e:
    ...
    def get_file_info(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "is_supported": file_path_obj.suffix.lower().lstrip('.') in self.supported_types
            }
