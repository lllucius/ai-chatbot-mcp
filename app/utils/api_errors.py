    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs) -> Any:
            try:
                ...
                raise HTTPException(
                    status_code=status.HTTP_400_BAD_REQUEST,
                    detail=_format_error_response(e.message, e.error_code, include_details, e.details)
                )
                ...
                raise HTTPException(
                    ...
                    detail=_format_error_response(default_message, "INTERNAL_SERVER_ERROR", include_details)
                )
