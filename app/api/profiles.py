"API endpoints for profiles operations."
...
async def get_profile_details(
    profile_name: str, current_user: User = Depends(get_current_user)
):
...
async def set_default_profile(
    profile_name: str, current_user: User = Depends(get_current_superuser)
):
...
async def validate_parameters(
    parameters: Dict[(str, Any)], current_user: User = Depends(get_current_user)
):
