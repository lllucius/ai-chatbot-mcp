...
class DocumentUploadResponse(BaseResponse):
    ...
    processing_started: bool = Field(False, description="Whether processing has started")
    estimated_completion: Optional[str] = Field(None, description="Estimated processing completion time")
