...
class Settings(BaseSettings):
    ...
    default_chunk_overlap: int = Field(
        default=200,
        description="Default chunk overlap for text processing",
        ge=0
    )
...
if settings.is_production and settings.secret_key == "change-this-super-secret-key-in-production-must-be-32-chars-minimum":
