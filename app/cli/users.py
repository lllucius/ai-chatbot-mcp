"Command-line interface for users management."
...
@user_app.command()
def show(username: str = typer.Argument(..., help="Username to show details for")):
    "Show operation."
...
@user_app.command()
def activate(username: str = typer.Argument(..., help="Username to activate")):
    "Activate operation."
...
@user_app.command()
def deactivate(username: str = typer.Argument(..., help="Username to deactivate")):
