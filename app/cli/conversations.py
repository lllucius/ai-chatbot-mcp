"Command-line interface for conversations management."
...
def archive(
    ...
    async def _archive_conversations():
        "Archive Conversations operation."
        async with AsyncSessionLocal() as db:
            try:
...
def search(
    ...
    async def _search_conversations():
        "Search Conversations operation."
        async with AsyncSessionLocal() as db:
            try:
