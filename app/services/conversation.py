...
class ConversationService(BaseService):
    ...
    async def list_conversations(
        self, user_id: str, page: int = 1, size: int = 20, active_only: bool = True
    ...
    async def update_conversation(
        self, conversation_id: str, request: ConversationUpdate, user_id: str
    ) -> Conversation:
        """
    ...
    async def get_messages(
        self, conversation_id: str, user_id: str, page: int = 1, size: int = 50
    ...
    async def process_chat(self, request: ChatRequest, user_id: str) -> Dict[str, Any]:
        """
    ...
    async def _get_registry_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.mcp_service:
                ...
                tools_registry = health.registry_stats
            else:
                tools_registry = {}
