...
class EmbeddingService:
    ...
    async def generate_embedding(self, text: str) -> Optional[List[float]]:
        ...
        try:
            ...
            embedding = await self.openai_client.generate_embedding(cleaned_text)
            
            # Validate embedding dimensions
            if len(embedding) != self.vector_dimension:
                logger.warning(f"Embedding dimension mismatch: expected {self.vector_dimension}, got {len(embedding)}")
                return None
    ...
    async def generate_embeddings_batch(self, texts: List[str]) -> List[Optional[List[float]]]:
        ...
        try:
            ...
            embeddings = await self.openai_client.generate_embeddings_batch(cleaned_texts)
            ...
            for i, embedding in enumerate(embeddings):
                ...
                if len(embedding) == self.vector_dimension:
                    ...
                    logger.warning(f"Embedding dimension mismatch for text {original_index}")
