...
class ConversationResponse(ConversationBase):
    ...
    id: str = Field(..., description="Conversation ID (MLID)")
    user_id: str = Field(..., description="Owner user ID (MLID)")
    ...
    model_config = {
        ...
        "json_encoders": {datetime: lambda v: v.isoformat(), str: lambda v: str(v)},
    }
