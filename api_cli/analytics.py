...
def overview():
    ...
    async def _show_overview():
        ...
        try:
            ...
            data = handle_api_response(response, "getting system overview")
...
def usage(
    ...
    async def _show_usage():
        ...
        try:
            params = {"period": period, "detailed": detailed}
            response = await client.get("/api/v1/analytics/usage", params=params)
            data = handle_api_response(response, "getting usage statistics")
...
def performance():
    ...
    async def _show_performance():
        ...
        try:
            ...
            data = handle_api_response(response, "getting performance metrics")
...
def users(
    ...
    async def _show_user_analytics():
        client = get_client_with_auth()
        
        try:
            params = {"metric": metric, "top": top, "period": period}
            response = await client.get("/api/v1/analytics/users", params=params)
            data = handle_api_response(response, "getting user analytics")
    ...
    asyncio.run(_show_user_analytics())
...
def trends(
    ...
    async def _show_trends():
        ...
        try:
            ...
            data = handle_api_response(response, "getting usage trends")
...
def export_report(
    ...
    async def _export_report():
        ...
        try:
            ...
            response = await client.post("/api/v1/analytics/export-report", params=params)
            data = handle_api_response(response, "exporting analytics report")
