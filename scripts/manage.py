...
def show_config():
    ...
    config_items = [
        ...
        ("DATABASE_URL", settings.database_url[:50] + "..." if len(settings.database_url) > 50 else settings.database_url, "Database connection"),
        ...
        ("MAX_FILE_SIZE", f"{settings.max_file_size // 1024 // 1024}MB", "Maximum file size"),
        ("ALLOWED_FILE_TYPES", ", ".join(settings.allowed_file_types), "Allowed file types"),
        ("DEFAULT_CHUNK_SIZE", str(settings.default_chunk_size), "Default chunk size"),
        ("DEFAULT_CHUNK_OVERLAP", str(settings.default_chunk_overlap), "Default chunk overlap"),
